...
void
RadiusOutlierFilter(const pcl::PointCloud<pcl::PointXYZ>::Ptr &pcd_cloud, const double &radius, const int &thre_count);
...
int main(int argc, char **argv) {
    ...
    private_nh.param("file_directory", file_directory,
                     std::string("/home/eric/ws_fast_lio2/src/FAST_LIO_ROS2/FAST_LIO/PCD/"));
    ROS_INFO("*** file_directory = %s ***\n", file_directory.c_str());


    private_nh.param("file_name", file_name, std::string("result"));
